...
use AppBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\User';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Mobile', 'Password', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'mobile', 'password', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::EMAIL, UserPeer::MOBILE, UserPeer::PASSWORD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'MOBILE', 'PASSWORD', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'mobile', 'password', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Mobile' => 2, 'Password' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'mobile' => 2, 'password' => 3, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::EMAIL => 1, UserPeer::MOBILE => 2, UserPeer::PASSWORD => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'MOBILE' => 2, 'PASSWORD' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'mobile' => 2, 'password' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
